...
namespace DunwoodyStudentProfile
{
    public partial class Form2 : MetroForm
    {
        ...
        private void b_ImgUpload_Click(object sender, EventArgs e)
        {
        ...
        private void dataGrid_DispRep_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void b_DisplayAll_Click(object sender, EventArgs e)
        {
            display_data();
        }
